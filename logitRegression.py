...
# data = pd.read_csv("localDatatest.csv")
# x0, x1, x2, x3, x4,y = data['0'],data['1'], data['2'], data['3'],data['4'],data['y']
print(data)
...
def argmaxLj(X, Y, nj):
    ...
    for i in range(iteration):
        ...
        if i % 500 == 0 :
            print("iteration:{0}\n beta:\n{1}".format(i,beta))
            print("likehood_value:",math.exp(Lj_beta(X,Y,beta)))
